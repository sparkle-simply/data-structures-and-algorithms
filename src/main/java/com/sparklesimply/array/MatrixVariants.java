...
public class MatrixVariants {
    ...
    /**
     * Problem statement: Given a 2-dimensional matrix of size ‘N’ x ‘M’,
     * rotate the elements of the matrix clockwise. The output matrix is generated by rotating the elements of the input matrix in a clockwise direction.
    ...
    /**
     * Problem statement: You have been given a 2-D array 'mat' of size 'M x N' where 'M' and 'N' denote
